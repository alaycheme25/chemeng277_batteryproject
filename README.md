...
```
pip install numpy, matplotlib, json, pandas, paretoset, pymatgen, scikit-learn, scipy, sympy
```

For conda users, run:
```
conda install -c conda-forge numpy, matplotlib, json, pandas, paretoset, pymatgen, scikit-learn, scipy, sympy
```
