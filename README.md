...
## Setup
Our machine-learning model is trained on data from \href{https://next-gen.materialsproject.org/}{Materials Project}, so you are not required to obtain your own data. However, the model requires certain packages to be installed to function properly.
